...
export default function OnboardingChat() {
  ...
  const onboardingQuestions = [
    ...
    {
      question:
        "Question 3: When would you like to receive reminder notifications? Please choose your preferred times",
      options: [
        "8am-10am",
        "10am-12pm",
        "12pm-2pm",
  ...
  useEffect(() => {
    if (user) {
      const intro = {
        id: `bot_intro`,
        text: "Hi! Glad you found your way here! 😊 I'd like to understand a bit more about you, please answer the following questions!",
        sender: "bot",
      };
